    ...
    stepsFuncs: [
        {
            ...
            step: 2,
            func: function() { 
                console.log("step function 2 ...") 
            },
            description: null
        },{
            step: 3,
            func: function() { 
                console.log("step function 3 ...") 
            },
            description: null
        },{
            step: 4,
            func: function() { 
                console.log("step function 4 ...") 
            },
            description: null
        },{
            step: 5,
            func: function() { 
                console.log("step function 5 ...") 
            },
            description: null
        },{
            step: 6,
            func: function() { 
                console.log("step function 6 ...") 
            },
            description: null
        },{
            step: 7,
            func: function() { 
                console.log("step function 7 ...") 
            },
            description: null
        },{
            step: 8,
            func: function() { 
                console.log("step function 8 ...") 
            },
            description: null
        },{
            step: 9,
            func: function() { 
                console.log("step function 9 ...") 
            },
            description: null
        },{
            step: 10,
            func: function() { 
                console.log("step function 10 ...") 
            },
            description: null
        }
    ],
